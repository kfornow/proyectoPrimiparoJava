...
import LOGICA.logica_añadir_instructor;
...
a una clase la cual se llama logica_añadir_instructor*/

public class jframe_añadir extends javax.swing.JFrame {

    logica_añadir_instructor añadir =new logica_añadir_instructor();
    
    public jframe_añadir() {
        initComponents();
        //volvemos invisibles los mensajes de erro para luego utilizarolos mas adelante
        mensaje_contrasena_invalid.setVisible(false);
        
        mensaje_invalid_confim_contra.setVisible(false);
        
        //volvemos el mensaje de error del email que declaramos mientras tipea el usuario ,invisible
        mensaje_invalid_email.setVisible(false);
        //posisionamos la ventana centradamente
    ...
    private void initComponents() {
        ...
        jPanel2.add(btt_continuar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 280, 90, 30));
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 70, 30));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 280, 70, 30));
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        jframe_main_cr_instr crmain=new jframe_main_cr_instr();
