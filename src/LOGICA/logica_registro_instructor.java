...
/*en este caso declare partes publicas del jframe_registro */


public final class logica_registro_instructor {
    
    
    conexion con = new conexion();// declaracion de objecto conexion para las consultas
    Connection cn =con.conexion();
    
    //esta variable la usaremos mas adelante para poder obtener el id del combo en la base de datos
    ...
    public void cargar_combo(){
        ...
        try {
            ...
            jframe_registro.cb_tipo_d_contrato.addItem("tipo de contrato");
            while(rs.next()){jframe_registro.cb_tipo_d_contrato.addItem(rs.getString("nombre"));}
    ...
    public void registro (){//creacion de metodo para la logica del registro del usuario en este caso el instructor
        ...
        try {
            ...
            int documento=Integer.parseInt(jframe_registro.txt_documento.getText());//parceo,del txt_documento que esta en el jframe registro
            ...
            if (resultado == false){
                ...
                try {
                    ...
                    String sql2 ="Select id_contrato from tipos_de_contrato where nombre='"+ jframe_registro.cb_tipo_d_contrato.getSelectedItem()+"'";
                    ...
                    pss1.setString(2, jframe_registro.txt_nombre.getText());  
                    pss1.setString(3, jframe_registro.txt_apellido.getText());
                    pss1.setString(4, jframe_registro.cb_edad.getSelectedItem().toString());
                    ...
                    pss2.setString(2,jframe_registro.txt_contraseña.getText());
                    pss2.executeUpdate();

                    PreparedStatement pss3 = cn.prepareStatement("INSERT INTO  conctacto_instructor(id_conct, telfon, email, cc_instruc_fk) values (?,?,?,?)");
                    pss3.setInt(1, 0);
                    pss3.setString(2, jframe_registro.txt_telefono.getText());
                    pss3.setString(3,jframe_registro.txt_email.getText());
        ...
        jframe_registro.txt_documento.setText("");
        jframe_registro.txt_nombre.setText("");
        jframe_registro.txt_apellido.setText("");
        jframe_registro.txt_telefono.setText("");
        jframe_registro.txt_email.setText("");
        jframe_registro.txt_contraseña.setText("");
        jframe_registro.txt_confirmContr.setText("");
        jframe_registro.cb_edad.setSelectedItem("Edad");
        jframe_registro.cb_tipo_d_contrato.setSelectedItem("tipo de contrato");
